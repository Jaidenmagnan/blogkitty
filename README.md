...
# Local Usage
To run the bot locally you must get your own `DISCORD_TOKEN` from the Discord developers portal. For the Discord side, I recommend [this](https://discordjs.guide/legacy/preparations/adding-your-app) documentation from discord.js (yes, even though this is Go).
